      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative w-full overflow-hidden pt-[180px] pb-[40px] md:pt-[200px] md:pb-[60px]" style={{ paddingTop: 'max(180px, calc(180px + env(safe-area-inset-top, 0px)))' }}>
          ...
          <div className="relative z-10 flex items-center justify-center px-5 sm:px-6 text-center">
            <div className="max-w-[820px] w-full">
              ...
              >
                You think you're ready for a health system.
                <br />
                Let's find out.
              </h1>
              ...
              >
                A structured written assessment for women's health founders who are 3 to 6 months from their first enterprise conversation — and need to know exactly where they stand.
              </p>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <p
              className="text-base sm:text-2xl font-inter font-bold mx-auto"
              style={{ color: '#1A2A3A', lineHeight: '1.6', maxWidth: '900px', textWrap: 'balance' }}
            >
              "You get a written report, a sequenced action plan, and a live findings call — so you walk into that pilot conversation knowing exactly what you're ready for and what you're not."
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-3">
              {[
                ...
                "You know your product is strong but aren't confident it will survive a health system's clinical and compliance teams",
                "You completed a Clinical Clarity Session and need a deeper structured plan to act on what you found",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8 mt-4">
              {[
                ...
                { step: "3", icon: FileText, title: "Written Clinical Readiness Report", text: "A prioritized 5 to 7 page assessment across five domains: clinical workflow fit, technology integration reality, physician adoption strategy, governance and risk infrastructure, and trust and liability exposure." },
                { step: "4", icon: Search, title: "Sequenced Remediation Roadmap", text: "A clear, ordered action plan — what to fix first and why." },
                { step: "5", icon: Phone, title: "60-Minute Live Findings Call", text: "Both practitioners on the call. Clinical and operational perspective together. Full Q&A. You leave knowing exactly what to do next." },
              ].map((item, i) => {
              ...
              {[
                {
                  ...
                  text: "Where your product lives in a physician's actual day and whether that's sustainable at scale.",
                },
                {
                ...
                },
                {
                  ...
                  text: "Who owns the outcome if your product influences a clinical decision that goes wrong — and whether your architecture reflects that answer.",
                },
              ].map((item, i) => (
                <div
                  key={i}
            ...
            >
              ...
              >
                "You don't need a signed contract to get started. You need the clarity to get one."
              </p>
              ...
              >
                Structured intake, written report, sequenced action plan, and a 60-minute live findings call with both practitioners.
              </p>
            </div>
          </div>
        </section>
