  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative w-full overflow-hidden pt-[180px] pb-[60px] md:pt-[240px] md:pb-[140px]" style={{ paddingTop: 'max(180px, calc(180px + env(safe-area-inset-top, 0px)))' }}>
          ...
          <div className="relative z-10 flex items-center justify-center px-5 sm:px-6 text-center">
            <div className="max-w-[820px] w-full">
              ...
              >
                90 minutes. A clear path forward.
              </h1>
            ...
            <div className="space-y-4">
              {[
                ...
                "You want an outside perspective from people who have been inside health systems — not just advised them",
                 ...
                 <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-[#D4B65D]/20">
                  <CheckCircle2 size={24} className="flex-shrink-0 mt-0.5" style={{ color: '#D4B65D' }} />
                  <p
        ...
        >
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2
                className="text-3xl sm:text-4xl font-playfair font-bold mb-4"
                style={{ color: '#1A2A3A', letterSpacing: '-0.02em' }}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                return (
                  <div
                    key={i}
                    className="flex flex-col p-8 rounded-2xl h-full transition-all duration-300 hover:-translate-y-1"
                    style={{
                      background: 'white',
                  ...
                  >
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6" style={{ background: 'rgba(212,182,93,0.1)' }}>
                      <Icon size={24} style={{ color: '#D4B65D' }} />
                    </div>
                    <h3 className="text-xl font-playfair font-bold mb-4" style={{ color: '#1A2A3A' }}>
                      {card.title}
                    </h3>
        ...
        <section
          className="px-4 sm:px-6 py-20 sm:py-28 relative overflow-hidden"
          style={{ background: '#1A2A3A' }}
        >
          <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'radial-gradient(circle at 50% 50%, #D4B65D 0%, transparent 50%)' }} />
          
          <div className="max-w-3xl mx-auto relative z-10 text-center">
            <h2
              className="text-3xl sm:text-4xl font-playfair font-bold mb-8"
              style={{ color: 'white', letterSpacing: '-0.02em' }}
            >
              This is not a discovery call in disguise.
            </h2>
            
            <div className="space-y-6 text-lg font-inter text-left mx-auto max-w-2xl" style={{ color: 'rgba(255,255,255,0.85)', lineHeight: '1.8' }}>
              <p>
        ...
        <section
          className="px-4 sm:px-6 py-20 sm:py-28 text-center"
          style={{ background: '#F5F0E4' }}
        >
          <div className="max-w-4xl mx-auto">
            <h2
              className="text-3xl sm:text-4xl md:text-5xl font-playfair font-bold mb-10"
              style={{ color: '#1A2A3A', letterSpacing: '-0.02em' }}
            >
            ...
            <Button
              onClick={handleBooking}
              className="text-sm sm:text-base font-semibold rounded-lg px-8 sm:px-12 py-5 sm:py-6 border group transition-all duration-500 hover:scale-[1.03] hover:shadow-[0_8px_40px_rgba(243,218,115,0.35)] mb-6"
              style={{
                background: 'linear-gradient(135deg, rgba(243,218,115,0.95) 0%, rgba(212,182,93,0.9) 100%)',
                color: '#2A3B4F',
                borderColor: 'rgba(255,255,255,0.25)',
