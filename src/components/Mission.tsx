...
const Mission = () => {
  ...
  return <section id="mission" ref={sectionRef} className="px-6 relative overflow-hidden" style={{
    paddingTop: '90px',
    paddingBottom: '90px',
    background: 'linear-gradient(180deg, rgba(255,255,255,0.97) 0%, rgba(113,141,169,0.04) 100%)'
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-24 items-start relative">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`} style={{
          maxWidth: '650px',
          transitionDelay: '0.2s'
            ...
            <div>
              ...
              <div className="relative inline-block">
                <p className="text-lg sm:text-xl font-inter font-light mb-2" style={{
                color: '#718DA9',
                lineHeight: '1.82'
              }}>
                  Built at the intersection of medicine, strategy, and innovation.
                </p>
                <div className="bg-[#F3DA73]" style={{
                width: '100%',
                height: '1.5px',
                opacity: 0.8
              }} />
            ...
            color: '#1E1E1E'
              ...
              <div className="mt-10 space-y-3 font-inter font-medium" style={{
              color: '#1E1E1E'
            }}>
                <p className="text-base sm:text-lg">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{
          transitionDelay: '0.5s'
        }}>
            <div className="flex flex-col gap-16 items-center">
              {/* John's Portrait */}
              <div className="text-center group" style={{
              marginTop: '16px'
            }}>
                <div className="relative">
                  <div className="relative w-64 h-64 rounded-full overflow-hidden mx-auto mb-4 transition-all duration-500 group-hover:-translate-y-2" style={{
                  ...
                  e.currentTarget.style.boxShadow = '0 12px 30px rgba(0,0,0,0.05), inset 0 0 20px rgba(243,218,115,0.2)';
                    ...
                    <img src={johnHeadshot} alt="John Faulkner - Healthcare Growth Architect" className="w-full h-full object-cover" loading="lazy" style={{
                    transform: 'scaleX(-1) scale(1.3) translateY(8%)'
                  }} />
                  </div>
                </div>
                <p className="font-inter text-base font-semibold" style={{
                color: '#1E1E1E'
              }}>
                  John Faulkner
                </p>
              ...
              marginTop: '16px'
                ...
                <div className="relative">
                  ...
                  e.currentTarget.style.boxShadow = '0 12px 30px rgba(0,0,0,0.05), inset 0 0 20px rgba(243,218,115,0.2)';
                    ...
                    <img src={nicoleHeadshot} alt="Dr. Nicole Faulkner - Board-Certified OB/GYN Physician" className="w-full h-full object-cover" loading="lazy" />
                  </div>
                </div>
                <p className="font-inter text-base font-semibold" style={{
                color: '#1E1E1E'
