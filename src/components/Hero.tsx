  ...
  return <section className="relative h-screen w-full overflow-hidden pt-20">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6 text-center">
        <div className="max-w-5xl animate-fade-in">
          ...
          <p className="mb-12 text-xl font-normal text-white/90 md:text-2xl lg:text-3xl max-w-3xl mx-auto">We help healthcare leaders escape broken systems & build organizations that thrive.</p>
