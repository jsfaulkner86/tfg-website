        ...
        <div className="px-8 flex items-center justify-between" style={{ paddingTop: '16px', paddingBottom: '16px' }}>
          ...
          <nav className="hidden md:flex items-center gap-12">
            ...
            <div className="flex items-center gap-1 ml-2">
              ...
              <a href="https://github.com/jsfaulkner86" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:bg-white/15 transition-all duration-300" aria-label="GitHub">
