...
const BottomVideo = () => {
  ...
  return <section ref={sectionRef} id="contact" className="relative h-screen w-full overflow-hidden">
      ...
      background: 'linear-gradient(to bottom, transparent, rgba(44,44,44,0.95))'
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-40 hover:opacity-60 transition-opacity">
          <img src={vantaBadge} alt="Vanta Partner" className="h-8 w-auto" />
        </div>
      </div>
    </section>;
};
