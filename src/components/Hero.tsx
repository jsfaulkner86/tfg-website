  ...
  return <section className="relative h-screen w-full overflow-hidden pt-20">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6 text-center pt-16">
        <div className="max-w-5xl opacity-0 animate-[fade-in_1.2s_ease-out_0.2s_forwards] translate-y-5">
          <h1
          className="mb-6 text-3xl font-display font-semibold text-white sm:text-4xl md:text-5xl lg:text-6xl relative overflow-hidden"
          style={{
          ...
          style={{
            ...
            <span className="relative">You Built Something ThatWorks. 
Now Let's Make Sure It Gets Used.<br />Now Let's Make Sure It Gets Used.</span>
          </h1>
